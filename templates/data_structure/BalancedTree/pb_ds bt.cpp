...
// 键不可重复的平衡树
using BST = __gnu_pbds::tree<int, __gnu_pbds::null_type, std::less<int>, __gnu_pbds::rb_tree_tag,
                 __gnu_pbds::tree_order_statistics_node_update>;

// 键可重复的平衡树，传pair
using MBST = __gnu_pbds::tree<std::pair<int, int>, __gnu_pbds::null_type,
